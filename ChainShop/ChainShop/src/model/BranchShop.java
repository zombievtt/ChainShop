...
public class BranchShop implements Serializable{
	...
	private Integer backR, backG, backB;
	private Integer foreR, foreG, foreB;
	...
	public BranchShop(String shopName, Integer backR, Integer backG, Integer backB, Integer foreR, Integer foreG,
			Integer foreB, String menu000Name, Integer menu000Price, String menu001Name, Integer menu001Price,
			String menu002Name, Integer menu002Price) {
		super();
	...
	public void setBackR(Integer backR) {
		this.backR = backR;
	}
	...
	public Integer getBackB() {
		return backB;
	}
	public void setBackB(Integer backB) {
		this.backB = backB;
	}
	public Integer getForeR() {
		return foreR;
	}
	public void setForeR(Integer foreR) {
		this.foreR = foreR;
	}
	public Integer getForeG() {
		return foreG;
	}
	public void setForeG(Integer foreG) {
		this.foreG = foreG;
	}
	public Integer getForeB() {
		return foreB;
	}
	public void setForeB(Integer foreB) {
		this.foreB = foreB;
	}
