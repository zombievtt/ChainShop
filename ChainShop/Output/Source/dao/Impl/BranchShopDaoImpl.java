...
import dao.BranchShopDao;
import dao.DbConnection;
import model.BranchShop;
import model.BuyOrder;

public class BranchShopDaoImpl implements BranchShopDao {

	public static void main(String[] args) {
//		BranchShop bs = new BranchShop("地球店", 0, 255, 255, 255, 255, 255, "肉絲炒麵", 90, "蛇肉炒麵", 120, "海鮮炒麵", 140);
...
//		for(BranchShop bs:l)
//		{
//			System.out.println("BrahShop: " + bs.getShopName());
//			System.out.println("BrahShop: " + bs.getBackR());
//			System.out.println("BrahShop: " + bs.getBackG());
//			System.out.println("BrahShop: " + bs.getBackB());
//			System.out.println("BrahShop: " + bs.getForeR());
//			System.out.println("BrahShop: " + bs.getForeG());
//			System.out.println("BrahShop: " + bs.getForeB());
//			System.out.println("BrahShop: " + bs.getMenu000Name());
//			System.out.println("BrahShop: " + bs.getMenu000Price());
//			System.out.println("BrahShop: " + bs.getMenu001Name());
//			System.out.println("BrahShop: " + bs.getMenu001Price());
//			System.out.println("BrahShop: " + bs.getMenu002Name());
//			System.out.println("BrahShop: " + bs.getMenu002Price());
//		}
		

		
//		List<BranchShop> l = new BranchShopDaoImpl().queryAllByShopName("地球店");
//		System.out.println("size: "+ l.size());
//		for (BranchShop bs:l)
//		{	
//			System.out.println("BrahShop: " + bs.getShopName());
...
//		BranchShop bs = new BranchShop("水星店", 0, 0, 255, 255, 255, 255, "豬肉炒麵", 125, "牛肉炒麵", 135, "海鮮炒麵", 145);
//		new BranchShopDaoImpl().updateBranchShopById(bs, 2);
		
//		new BranchShopDaoImpl().deleteBranchShopById(4);
	...
	public List<BranchShop> queryAllByShopName(String shopName)
	{
		...
		List<BranchShop> l = new ArrayList<BranchShop>();
